                    ...
                    <div className="col-lg-6 col-md-8">
                        <div className="inner">
                            <ul className="axil-breadcrumb">
                                ...
                                <li className="axil-breadcrumb-item active" aria-current="page">Pages</li>
                            </ul>
                ...
                <div className="row">
                    <div className="col-lg-10">
                        <div className="axil-privacy-policy">
                            ...
                            <p>This website is operated by Dazzle Sportswear. Throughout the site, the terms “we”, “us” and “our” refer to Dazzle Sportswear and “you” “your” refers to the reader/customer. </p>
                           
                            <p>We offer this website, including all information, tools and services available from this site to you, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
...
<p>If you do not agree to all the terms and conditions of this agreement, then you may not access the website or use any services. </p> 

<p>If these Terms of Service are considered as an offer, acceptance is expressly limited to these Terms of Service. Any new features or tools which are added to the current store shall also be subject to the Terms of Service. You can review the most current version of the Terms of Service at any time on this page. </p> 
...
<p>We reserve the right to update, change or replace any part of these Terms of Service by posting updates and/or changes to our website. It is your responsibility to check this page periodically for changes. Your continued use of or access to the website following the posting of any changes constitutes acceptance of those changes.</p> 
                            ...
                            <h4 className="title">SECTION 1 - ONLINE INFORMATION TERMS</h4>
                            <p>By agreeing to these Terms of Service, you represent that you are at least at the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.
</p>
                            <ul>
                                <li>You may not use our products for any illegal or unauthorized purpose nor may you, in the use of the Service, violate any laws in your jurisdiction (including but not limited to copyright laws)
</li>
                                <li>You must not transmit any bugs, viruses or any code of a destructive nature
</li>
                                <li>A breach or violation of any of the Terms will result in an immediate termination of your services
</li>
                               
                            </ul>
                            <h4 className="title">SECTION 2 - GENERAL CONDITIONS
</h4>

                            <ul>
                                <li>We reserve the right to refuse services to anyone for any reason at any time.
You understand that your content (not including credit/debit card information), may be transferred unencrypted and involve 
transmissions over various networks; and </li>
                                <li>changes to conform and adapt to technical requirements of connecting networks or devices</li>
                               
                            </ul>
                           <p>You agree not to reproduce, duplicate, copy, sell, resell or exploit any portion of the service, use of the service, or access to the service or any contact on the website through which the service is provided, without expressing written permission by us.</p> 
...
<p>Any reliance on the material on this site is at your own risk. This site may contain certain historical information. </p>

<p>Historical information, necessarily, is not current and is provided for your reference only. We reserve the right to modify the contents of this site at any time, but we have no obligation to update any information on our site. You agree that it is your responsibility to monitor changes to our site.</p>


<h4 className="title">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h4>
...
<h4 className="title">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h4>
<ul>
...
<li>We reserve the right to limit the quantities of any products or services that we offer. All descriptions of products or product pricing are subject to change at any time without notice, at the sole discretion of us. </li>
...
<h4 className="title">SECTION 6 - OPTIONAL TOOLS</h4>
...
<h4 className="title">SECTION 7 - THIRD-PARTY LINKS</h4>
...
<p>Please review carefully the third-party's policies and practices and make sure you understand them before you engage in any transaction. Complaints, claims, concerns, or questions regarding third-party products should be directed to the third-party only.</p>



<h4 className="title">SECTION 8 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4>
...
<p>You agree that your comments will not violate any right of any third-party, including copyright, trademark, privacy, personality or other personal or proprietary right. </p>

<p>You further agree that your comments will not contain libelous or otherwise unlawful, abusive or obscene material, or contain any computer virus or other malware that could in any way affect the operation of the Service or any related website. </p>

<p>You may not use a false e-mail address, pretend to be someone other than yourself, or otherwise mislead us or third-parties as to the origin of any comments. </p>
...
<h4 className="title">SECTION 9 - PERSONAL INFORMATION</h4>
...
<h4 className="title">SECTION 11 - PROHIBITED USES</h4>
...
<h4 className="title">SECTION 12 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h4>
...
<h4 className="title">SECTION 13 - INDEMNIFICATION</h4>

<p>You agree to indemnify, defend and hold harmless Dazzle Sportswear and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party. </p>

<h4 className="title">SECTION 14 - SEVERABILITY</h4>

<p>In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.</p>


<h4 className="title">SECTION 15 - TERMINATION</h4>
...
<h4 className="title">SECTION 16 - ENTIRE AGREEMENT</h4>
...
<h4 className="title">SECTION 17 - GOVERNING LAW</h4>

<p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of IPC, India.</p>


<h4 className="title">SECTION 18 - CHANGES TO TERMS OF SERVICE</h4>
...
<p>It is your responsibility to check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.</p>


<h4 className="title">SECTION 19 - CONTACT INFORMATION</h4>

<p>Questions about the Terms of Service should be sent to us at info@dazzlesportswear.com</p>


<h4 className="title">SECTION 20 - LEGAL JURISDICTION</h4>

<p>Any legal disputes whatsoever arising are subject to the jurisdiction of Hyderabad, Telangana.</p>
