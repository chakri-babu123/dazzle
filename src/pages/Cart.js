        ...
        <div className="axil-product-cart-wrap">
            ...
            <div className='row'>
                ...
                <table className="table axil-product-table axil-cart-table mb--40">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="product-thumbnail"><Link to={"/singleproductdetails"}><img src="assets/images/product/electric/product-01.png" alt="Digital Product"/></Link></td>
                            <td className="product-title"><Link to={"/singleproductdetails"}>Wireless PS Handler</Link></td>
                        ...
                        <tr>
                            <td className="product-remove"><a href="#" className="remove-wishlist"><i className="fal fa-times"></i></a></td>
                            <td className="product-thumbnail"><Link to={"/singleproductdetails"}><img src="assets/images/product/electric/product-02.png" alt="Digital Product"/></Link></td>
                            <td className="product-title"><Link to={"/singleproductdetails"}>Gradient Light Keyboard</Link></td>
                            <td className="product-price" data-title="Price"><span className="currency-symbol">₹ </span>124.00</td>
                            <td className="product-quantity" data-title="Qty">
                                <div className="pro-qty">
                                    <input type="number" className="quantity-input" value="1"/>
                        ...
                        <tr>
                            <td className="product-remove"><a href="#" className="remove-wishlist"><i className="fal fa-times"></i></a></td>
                            <td className="product-thumbnail"><Link to={"/singleproductdetails"}><img src="assets/images/product/electric/product-03.png" alt="Digital Product"/></Link></td>
                            <td className="product-title"><Link to={"/singleproductdetails"}>HD CC Camera</Link></td>
                            <td className="product-price" data-title="Price"><span className="currency-symbol">₹ </span>124.00</td>
                            <td className="product-quantity" data-title="Qty">
                                <div className="pro-qty">
                                    <input type="number" className="quantity-input" value="1"/>
                ...
                <div className="col-lg-12">
                    <div className="axil-order-summery">
                        ...
                        <Link to={"/checkout"} className="axil-btn add-cart-btn-custom checkout-btn">Process to Checkout</Link>
                    </div>
                </div>
            </div>
                </div>
